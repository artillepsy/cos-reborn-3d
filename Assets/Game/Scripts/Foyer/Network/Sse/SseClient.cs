...
namespace Game.Scripts.Foyer.Network.Sse
{
    ...
    {
        public event Delegates.VoidStringDelegate OnMessageEvent;
        public event Delegates.VoidStringDelegate OnErrorEvent;
        public event Delegates.VoidDelegate OnCompleteEvent;
        public event Delegates.VoidDelegate OnEndEvent;
        public event Delegates.VoidDelegate OnBeginEvent;
        ...
        private static void TryCatchInvoke(Delegates.VoidStringDelegate messageDelegate, string message)
        {
            try
            {
        ...
        private static void TryCatchInvoke(Delegates.VoidDelegate voidDelegate)
        {
            try
            {
                voidDelegate?.Invoke();
